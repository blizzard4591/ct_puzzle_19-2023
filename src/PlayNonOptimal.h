#ifndef PLAYNONOPTIMAL_H_
#define PLAYNONOPTIMAL_H_
...
void playNonOptimal(std::array<std::string, NUM_ROWS> const& fieldString, std::vector<std::pair<std::size_t, std::size_t>> const& holeConnections) {
